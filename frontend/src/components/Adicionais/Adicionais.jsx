import {InputGroup, Form, Button, Container, Row, Col, Image} from 'react-bootstrap';
...
function Adicionais({ modoExibicao }) {
  return (
    <>
      <Container fluid>
      ...
      <Container fluid>
        <Row className="justify-content-end">
          ...
          <InputGroup className="mb-3">
                ...
                <Form.Control placeholder="Link" aria-label="Link" aria-describedby="basic-addon1" readOnly={modoExibicao === "exibir"}/>
                </InputGroup>
                <InputGroup className="mb-3">
            ...
            <Button type="submit" variant="outline-success" disabled={modoExibicao === "exibir"}>Salvar</Button>
          </Col>
        </Row>
      <hr/>
      </Container>
